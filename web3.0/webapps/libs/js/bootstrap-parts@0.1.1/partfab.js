      ...
      <ul class="fab-options">
        <li>
          ...
          <div class="fab-icon-holder">
            <a target="_blank" href="https://web.facebook.com/construct2n3"><i class="fa-brands fa-facebook text-primary"></i></i></a>
          </div>
        </li>
        <li>
          <span class="fab-label">ติดต่อเรา</span>
          <div class="fab-icon-holder">
            <a target="_blank" href="https://mail.google.com/mail/u/0/?fs=1&to=ph.wichian@gmail.com&tf=cm"><i class="fas fa-envelope text-danger"></i></a>
          </div>
        </li>
        <li style="margin-bottom: 50px;">
          <span class="fab-label">สนับสนุนเรา</span>
          <div class="fab-icon-holder">
            <a target="_blank" href="https://guruchian.blogspot.com/p/donate.html"><img src="https://semicon.github.io/img/web/cafe.png" class="rounded-circle" style="width: 90%;"></a>
          </div>
        </li>
      </ul>
</div>`)
