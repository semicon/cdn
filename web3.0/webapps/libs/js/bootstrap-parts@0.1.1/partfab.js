      ...
      const fabActive = document.querySelector("div fab-active")
      if (!tags) {
...
<div style="position: absolute;  left: 50%;  top: 50%; z-index:15; color:red; transform: translate(-50%, -50%);"><center><h2>Sorry!, you are violating the terms.</h2></center></div>
      ...
      if (!developerName || !developer || !nicknamedev) {
        elemx.remove();
        document.write(`<footer class="container p-5"><div class="col-md-12 copyright text-center"> 
<p>Copyright   <img src="https://mirrors.creativecommons.org/presskit/icons/heart.red.png" width="25" height="25" alt="${nicknamedev}" /> 2023${dd}, developed by <a  href="https://guruchian.blogspot.com/" target="_blank" alt="ดร.วิเชียร พุ่มพวง"> Dr.Wichian Ph.</a></p></div>
</div>
</footer>`);
      }
if (!fabActive) {
...
$("#fab-active").html(`<div class="fab-container">
      ...
      <ul class="fab-options">
        ...
        <li style="margin-bottom: 60px;">
          ...
          <div class="fab-icon-holder">
            <a target="_blank" href="https://guruchian.blogspot.com/p/donate.html"><img src="https://sv1.picz.in.th/images/2023/07/24/MolhWv.png" class="rounded-circle" style="width: 100%;"></a>
          </div>
        </li>
      </ul>
</div>`)
