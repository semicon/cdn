...
$("#fab-active").html(`<div class="fab-container">
      ...
      <ul class="fab-options">
        ...
        <li style="margin-bottom: 60px;">
          ...
          <div class="fab-icon-holder">
            <a target="_blank" href="https://guruchian.blogspot.com/p/donate.html"><img src="https://semicon.github.io/img/web/MolhWv.png" class="rounded-circle" style="width: 100%;"></a>
          </div>
        </li>
      </ul>
</div>`)
